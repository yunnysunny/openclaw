...
// Stage 4 compat alias: upstream renamed retainGeneratedOwnerDisplaySecret.
export const persistGeneratedOwnerDisplaySecret = retainGeneratedOwnerDisplaySecret;
